...
function exchange(state = {}, action) {
    ...
    switch (action.type) {
        ...
        case 'OPEN_ORDERS_LOADED':
            return { ...state, openOrders: { loaded: true, data: action.openOrders } }
        // case 'BUY_FILLED_ORDERS_LOADED':
        //     return { ...state, buyFilledOrders: { loaded: true, data: action.buyFilledOrders } }
        // case 'SELL_FILLED_ORDERS_LOADED':
        //     return { ...state, sellFilledOrders: { loaded: true, data: action.sellFilledOrders } }
        case 'BUY_ORDERBOOK_LOADED':
            return { ...state, buyOrderBook: { loaded: true, data: action.buyOrderBook } }
        case 'SELL_ORDERBOOK_LOADED':
            return { ...state, sellOrderBook: { loaded: true, data: action.sellOrderBook } }
        ...
        case 'UPDATE_ORDER_CANCELLING_FLAG_FALSE':
