			...
			<Container fluid>
				<Navbar expand="xl" className="card mb-0" style={{ zIndex: 100 }}>
					<Container fluid className="d-flex">
						...
						<Nav className={`navbar-nav ml-auto d-flex flex-row align-items-center`} style={{ order: 2 }}>
									...
									(
										<>
											<Fragment>
												...
												{/* User Menu */}
												<Dropdown className="header-btn user-menu" id="personalBtn" onClick={() => {
														this.setState({personalMenuOpen : !this.state.personalMenuOpen});
													...
													<Dropdown.Menu align="end" className="personal-menu">
														...
														<div className="dropdown-item no-hover">
															<Button variant='outline-success' size='sm' className="w-100" onClick={() => {
														...
														<div className="dropdown-body">
															...
															<Link to="/settings" className="dropdown-item" onClick={() => {
																document.getElementById("personalBtn").click()
															}}>
											...
											<div className="header-btn mobile-menu dropdown">
												<Navbar.Toggle id="toggleBtn" aria-controls="basic-navbar-nav" onClick={() => {
													this.setState({ menuOpen: !this.state.menuOpen })
													if(this.state.personalMenuOpen == true){
														document.getElementById('personalBtn').click();
													}
													else	
														return;
						...
						<Navbar.Collapse id="basic-navbar-nav" className="navbar-menu">
							<Nav className="navbar-nav mr-auto mobile-menu">
								<a className="nav-link" href="/players/pdummett" onClick={() => {
									document.getElementById("toggleBtn").click()
								}}>
									Transfer Market
								</a>
								<Link to="/players" className="nav-link" onClick={() => {
									document.getElementById("toggleBtn").click()
								}}>
									All Players
								</Link>
								<Link to="/ipos" className="nav-link" onClick={() => {
									document.getElementById("toggleBtn").click()
								}}>
									IPO's
								</Link>
								...
								<NavDropdown id="rewardBtn" title="Rewards" onClick={() => {
									this.setState({ menuRewardOpen: !this.state.menuRewardOpen });
									this.setState({ menuotherOpen: false })
								}} className={this.state.menuRewardOpen ? 'backColor' : ''}>
									<Link to="/rankings" className="dropdown-item" onClick={() => {
										document.getElementById('rewardBtn').click();
										document.getElementById("toggleBtn").click()
									}}>
										Live Rankings
									</Link>
									<Link to="/teamoftheweek" className="dropdown-item" onClick={() => {
										document.getElementById('rewardBtn').click();
										document.getElementById("toggleBtn").click()
									}}>
										Team Of The Week
									</Link>
									<Link to="/teamofthemonth" className="dropdown-item" onClick={() => {
										document.getElementById('rewardBtn').click();
										document.getElementById("toggleBtn").click()
									}}>
										Team Of The Month
									</Link>
									<Link to="/teamoftheseason" className="dropdown-item" onClick={() => {
										document.getElementById('rewardBtn').click();
										document.getElementById("toggleBtn").click()
									}}>
										Team Of The Season
									</Link>
									<Link to="/inplay" className="dropdown-item" onClick={() => {
										document.getElementById('rewardBtn').click();
										document.getElementById("toggleBtn").click()
									}}>
										Inplay Rewards
									</Link>
									<Link to="/myrewards" className="dropdown-item" onClick={() => {
										document.getElementById('rewardBtn').click();
										document.getElementById("toggleBtn").click()
									}}>
										My Rewards
									</Link>
									<Link to="/payouts" className="dropdown-item" onClick={() => {
										document.getElementById('rewardBtn').click();
										document.getElementById("toggleBtn").click()
									}}>
										Reward Wallets
								...
								<NavDropdown id="otherBtn" title="Other" onClick={() => {
									this.setState({ menuotherOpen: !this.state.menuotherOpen });
									this.setState({ menuRewardOpen: false })
								}} className={this.state.menuotherOpen ? 'backColor' : ''}>
									<a className="dropdown-item" href="/recents" onClick={() => {
										document.getElementById('otherBtn').click();
										document.getElementById("toggleBtn").click()
									}}>
										Market Activity
									</a>
									<a className="dropdown-item" href="/openorders" onClick={() => {
										document.getElementById('otherBtn').click();
										document.getElementById("toggleBtn").click()
									}}>
										My Open Orders
									</a>
									<Link to="/news" className="dropdown-item" onClick={() => {
										document.getElementById('otherBtn').click();
										document.getElementById("toggleBtn").click()
									}}>
										News
									</Link>
									<Link to={{ pathname: `https://link.medium.com/iurre80R4mb` }} target="_blank" className="dropdown-item" onClick={() => {
										document.getElementById('otherBtn').click();
										document.getElementById("toggleBtn").click()
									}}>
										FAQ
									</Link>
									<Link to={{ pathname: `https://discord.gg/nCgkhNZesZ` }} target="_blank" className="dropdown-item" onClick={() => {
										document.getElementById('otherBtn').click();
										document.getElementById("toggleBtn").click()
									}}>
										Discord
				...
				{
					this.state.uid !== "" && this.state.uid !== null && this.state.uid !== undefined ? <div className="ticker-wrap" style={{ width: "0%" }}>
					...
					</div> : <div className="pb-5 pt-5"></div>
				}
				<div className={this.state.menuOpen || this.state.personalMenuOpen ? 'overwrite-div' : ''} onClick={() => {
					if(this.state.menuOpen == true)
						document.getElementById("toggleBtn").click();
					if(this.state.personalMenuOpen == true)
						document.getElementById("personalBtn").click();
					this.setState({ menuRewardOpen: false });
					this.setState({ menuotherOpen: false });
					this.setState({personalMenuOpen : false});
				}}></div>
			</Container>
		);
	}
