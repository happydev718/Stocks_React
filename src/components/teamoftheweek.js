...
const rankdataurl = configURL.teamoftheweek;
...
class Teamoftheweeklist extends Component {
	constructor(props) {
		super(props);
		this.state = {
			rankdata: null,
	...
	async componentDidMount() {
		...
		if (!rankdata || rankdata === "") {
			this.setState({ rankingdate: "Error: No data available" });
		} else {
			this.setState({
				rankdata: rankdata,
			});
...
export default connect(mapStateToProps)(Teamoftheweeklist);
