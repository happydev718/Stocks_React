...
const rankdataurl = configURL.teamofthemonth;

class TeamOfTheMonth extends Component {
...
class TeamoftheMonthlist extends Component {
	constructor(props) {
		super(props);
		this.state = {
			rankdata: null,
	...
	async getRankingDate() {
		let query_rankingdate = await db.collection("rankingsdate").doc("teamofthemonth").get();
...
export default connect(mapStateToProps)(TeamoftheMonthlist);
