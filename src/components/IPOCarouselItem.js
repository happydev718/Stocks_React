			...
			<div className="card">
				...
				<div className="card-body">
					...
					<div className='mb-3 w-100'>
						<Col className='pt-3' md style={{fontSize: '.9rem', borderTop: 'var(--bs-card-border-width) solid var(--bs-card-border-color)', color: '#858789'}}>
							Price: <span className='ipo-price'>132,320.18</span> <span style={{fontSize: '.65rem'}}>0.067 ETH</span>
						</Col>
					</div>
					<Button
						variant='success'
